...
> Automated [Blueprint.zip](https://blueprint.zip) installer for Pterodactyl Panel.  
> Blueprint is the industry-leading extension framework for Pterodactyl â€” install, manage, and develop extensions without touching core panel files.
